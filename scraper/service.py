...
class ScrapeData(object):
    ...
    def __init__(self, querystring, backend) -> None:
    ...
    def list_of_urls(self):
        ...
        self._urls_to_scrape = list([url for url in raw_urls if ("glassdoor.com" in url and "SRCH_KT" in url)])
    ...
    def scraped(self):
        ...
        scrapedpage = requests.get(self._urls_to_scrape, headers= ScrapeData.HEADERS)	
